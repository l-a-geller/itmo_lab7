...
public class Client {
   ...
   /**
    * Reads login & registration data and commands from user
    */
   public static void main(String[] args) throws IOException, ClassNotFoundException {
      ...
      try {
         ...
         if (args.length >= 2) {
            try { serverConnector.connect(args[0], Integer.parseInt(args[1])); // connecting to server
         ...
         while(true) {
            ...
            if (!logged){
               ...
               }else if (flag.equals("A")) continue;
               else break;
            }
        }
